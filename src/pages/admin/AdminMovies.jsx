...
// Dados fixos para visualização
const movies = [
  { id: 1, title: 'O AGENTE SECRETO', poster: 'https://placehold.co/300x450/d97706/black?text=Agente' },
  { id: 2, title: 'O TELEFONE PRETO 2', poster: 'https://placehold.co/300x450/white/black?text=Telefone+Preto+2' },
                        ...
                        />
                         ...
                         {!isSelected && (
                             <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 to-transparent rounded-b-2xl">
                                <p className="text-white text-center font-bold text-sm uppercase drop-shadow-md">{movie.title}</p>
                             </div>
                         )}
